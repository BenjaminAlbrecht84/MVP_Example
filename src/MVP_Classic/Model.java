...
public class Model {
    ...
    static final ArrayList<Character> DNA_ALPHABET = new ArrayList<>(Arrays.asList('A', 'C', 'T', 'G'));
    static final ArrayList<Character> RNA_ALPHABET = new ArrayList<>(Arrays.asList('A', 'C', 'U', 'G'));
    ...
    public ArrayList<String> getRnaSequences() {
        return rnaSequences;
    }

    public ArrayList<String> getDnaSequences() {
        return dnaSequences;
    }
